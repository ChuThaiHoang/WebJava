                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <ul class="list-group category_block">
                            <c:forEach items="${sessionScope.listCC}" var="o">
                                <li class="list-group-item text-white ${tag == o.cid ? "active":""}"><a href="ViewProductByCategory?cid=${o.cid}">${o.cname}</a></li>
                            </c:forEach>
                        ...
                        <c:forEach items="${requestScope.listP}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="ViewProduct?pid=${o.id}" title="View Product">${o.name}</a></h4>

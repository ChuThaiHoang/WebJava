<%-- 
    ...
    Created on : Jun 10, 2023, 2:10:16 PM
    Author     : eotke
--%>
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.category}" var="o">
                            <tr>                               
                                ...
                                <td>${o.lock}</td>
                                <td>
                                    <a href="LoadEditCatrgory?EditID=${o.cid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="DeleteCategory?Deteleid=${o.cid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>

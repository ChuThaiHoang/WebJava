                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">                           
                            ...
                            <a class="btn btn-success btn-sm ml-3" href="OrderTracking">
                                        <i class="fa"></i> Order Tracking
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.listProduct}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="LoadEditProduct?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

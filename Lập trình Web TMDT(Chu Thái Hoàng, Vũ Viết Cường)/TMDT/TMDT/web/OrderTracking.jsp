                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${requestScope.listCart}" var="o">
                                                <tr>
                                                    ...
                                                    <c:if test="${o.buy == 0}">
                                                        <td class="align-middle"><a href="CancelOderCartBySeller?dealID=${o.id}" class="text-dark">
                                                            <button type="button" class="btn btn-danger">Cancel</button>
                                                        </a>
                                                    </td>
                                                        <td class="align-middle"><a href="OderConfirmationCartBySeller?dealID=${o.id}" class="text-dark">
                                                            <button type="button" class="btn btn-danger">Order confirmation</button>
                                                        </a>
                                                    </td>     
                                                    </c:if>
                                                    <c:if test="${o.buy == 1}">
                                                    ...
                                                    <c:if test="${o.buy == 3}">
                                                        ...
                                                        <td class="align-middle"><strong>Đã huỷ bởi khách hàng</strong></td>      
                                                    </c:if>
                                                        <c:if test="${o.buy == 4}">
                                                       <td class="align-middle">
                                                    </td>
